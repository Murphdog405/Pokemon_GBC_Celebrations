...
BrockData:
	...
	db $FF, 66, GOLEM, 66, GOLBAT, 66, AERODACTYL, 66, NINETALES, 66, OMASTAR, 66, ONIX, 0

MistyData:
	db $FF, 18, PSYDUCK, 18, STARYU, 22, STARMIE, 0
	db $FF, 66, GOLDUCK, 66, GYARADOS, 66, STARMIE, 66, SEADRA, 66, LAPRAS, 66, BLASTOISE, 0

LtSurgeData:
	db $FF, 24, ELECTABUZZ, 25, MAGNETON, 25, PIKACHU, 28, RAICHU, 0
	db $FF, 66, ELECTRODE, 66, PORYGON, 66, JOLTEON, 66, ELECTABUZZ, 66, PIKACHU, 66, RAICHU, 0

ErikaData:
	db $FF, 33, EXEGGCUTE, 34, VICTREEBEL, 34, TANGELA, 37, VILEPLUME, 0
	db $FF, 66, VENUSAUR, 66, TANGELA, 66, CHANSEY, 66, VICTREEBEL, 66, EXEGGUTOR, 66, VILEPLUME, 0

KogaData:
	db $FF, 43, GOLBAT, 43, MUK, 43, WEEZING, 44, VENOMOTH, 0
	db $FF, 66, ARBOK, 66, GOLBAT, 66, WEEZING, 66, TENTACRUEL, 66, MUK, 66, VENOMOTH, 0

BlaineData:
	db $FF, 47, FLAREON, 47, NINETALES, 47, RAPIDASH, 48, ARCANINE, 48, MAGMAR, 0
	db $FF, 66, ARCANINE, 66, NINETALES, 66, RHYDON, 66, FLAREON, 66, CHARIZARD, 66, MAGMAR, 0

SabrinaData:
	db $FF, 45, SLOWBRO, 45, MR_MIME, 45, JYNX, 45, HYPNO, 46, ALAKAZAM, 0
	db $FF, 66, GENGAR, 66, SLOWBRO, 66, MR_MIME, 66, JYNX, 66, HYPNO, 66, ALAKAZAM, 0
