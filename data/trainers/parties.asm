...
JanineData:
; Fuchsia Gym
	db 38, VENONAT, GOLBAT, NIDOQUEEN, VENOMOTH, 0
...
; Route 14
	...
	db 36, PIDGEOTTO, SPEAROW, DODUO, FEAROW, 0
	db 39, PIDGEOTTO, DODRIO, 0
	db 38, PIDGEOTTO, DODUO, FEAROW, 0
...
JoyData:
;Fuchsia Pokecenter
	db 70, KANGASKHAN, SNORLAX, STARMIE, PORYGON, EXEGGUTOR, CHANSEY, 0
...
JennyData:
; Vermilion City
	db 70, PIDGEOT, BLASTOISE, TANGELA, GENGAR, PARASECT, ARCANINE, 0
