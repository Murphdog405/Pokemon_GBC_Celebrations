...
IndigoPlateauLobby_Object:
	...
	object_event  0,  9, SPRITE_GYM_GUIDE, STAY, RIGHT, TEXT_INDIGOPLATEAULOBBY_GYM_GUIDE
	object_event  6,  1, SPRITE_COOLTRAINER_F, STAY, DOWN, TEXT_INDIGOPLATEAULOBBY_COOLTRAINER_F
	object_event  0,  5, SPRITE_CLERK, STAY, RIGHT, TEXT_INDIGOPLATEAULOBBY_CLERK
	object_event  0,  7, SPRITE_BIKE_SHOP_CLERK, STAY, RIGHT, TEXT_INDIGOPLATEAULOBBY_POST_GAME_CLERK
